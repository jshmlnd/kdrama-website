  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-7xl px-4 pb-16 pt-12 sm:px-6 lg:px-8">
        <div className="max-w-2xl"><p className="section-kicker"><Search size={14} /> The full collection</p><h1 className="mt-3 font-display text-5xl leading-none text-white sm:text-8xl">Find your <span className="italic text-primary">next</span> favorite.</h1><p className="mt-5 text-sm leading-6 text-neutral-content sm:text-base">Search every title in the live catalog, then save the ones you want to remember.</p></div>

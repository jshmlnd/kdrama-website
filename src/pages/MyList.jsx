  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-7xl px-4 pb-16 pt-12 sm:px-6 lg:px-8">
        <div className="max-w-2xl"><p className="section-kicker"><Bookmark size={14} /> Saved for later</p><h1 className="mt-3 font-display text-5xl leading-none text-white sm:text-8xl">Your <span className="italic text-primary">list.</span></h1><p className="mt-5 text-sm leading-6 text-neutral-content sm:text-base">A personal shelf for the stories you are not ready to let go of.</p></div>
